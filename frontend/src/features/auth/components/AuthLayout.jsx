...
const AuthLayout = ({
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-[#fafafa]">
            <div className={`w-full max-w-md bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-10 border border-gray-100 ${cardClassName}`}>
                {/* Header */}
                ...
                <div className="relative flex items-center justify-center mt-6 mb-6">
                    ...
                    <div className="relative bg-white px-4 text-xs font-medium text-gray-500 uppercase tracking-widest">
                        Or continue with
                    </div>
                </div>
